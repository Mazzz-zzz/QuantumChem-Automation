...
label = '2003846667223680600001_R_Addition_MultipleBond_5_2_3_IRC_R'
logfile = '2003846667223680600001_R_Addition_MultipleBond_5_2_3_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('H')], positions=[[np.float64(-0.657789), np.float64(-1.319415), np.float64(-0.015926)], [np.float64(-0.081778), np.float64(0.05826), np.float64(0.33563)], [np.float64(-0.520746), np.float64(1.012339), np.float64(-0.56366)], [np.float64(-0.418452), np.float64(0.409827), np.float64(1.636667)], [np.float64(1.960731), np.float64(0.030099), np.float64(0.368134)], [np.float64(2.410089), np.float64(0.620524), np.float64(1.774705)], [np.float64(2.552042), np.float64(-1.354862), np.float64(-0.163207)], [np.float64(2.084028), np.float64(1.27568), np.float64(-0.949716)], [np.float64(-0.290327), np.float64(-1.669501), np.float64(-1.307856)], [np.float64(-0.177269), np.float64(-2.267413), np.float64(0.880308)], [np.float64(-2.04834), np.float64(-1.285362), np.float64(0.064223)], [np.float64(3.043884), np.float64(1.378102), np.float64(-1.189302)]])

kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '28GB', 'chk': '2003846667223680600001_R_Addition_MultipleBond_5_2_3_IRC_R', 'label': '2003846667223680600001_R_Addition_MultipleBond_5_2_3_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Read,Mix', 'geom': 'AllCheck,NoKeepConstants', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '2003846667223680600001_R_Addition_MultipleBond_5_2_3_IRC_R_prod'
    logfile = '2003846667223680600001_R_Addition_MultipleBond_5_2_3_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '28GB', 'chk': '2003846667223680600001_R_Addition_MultipleBond_5_2_3_IRC_R_prod', 'label': '2003846667223680600001_R_Addition_MultipleBond_5_2_3_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Mix,Always', 'freq': 'freq', 'opt': 'CalcFC'}
