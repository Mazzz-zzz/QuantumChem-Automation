...
label = '2003846667223680600001_r13_insertion_RSR_9_1_2_5_IRC_R'
logfile = '2003846667223680600001_r13_insertion_RSR_9_1_2_5_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('H')], positions=[[np.float64(1.746584), np.float64(-0.005189), np.float64(-0.139297)], [np.float64(2.349172), np.float64(1.259172), np.float64(-0.018812)], [np.float64(3.27812), np.float64(1.359069), np.float64(0.920381)], [np.float64(2.696492), np.float64(1.837004), np.float64(-1.150652)], [np.float64(0.58315), np.float64(2.456866), np.float64(0.724734)], [np.float64(-0.177614), np.float64(2.869415), np.float64(-0.400112)], [np.float64(0.32088), np.float64(2.508233), np.float64(2.128177)], [np.float64(1.805547), np.float64(3.545938), np.float64(0.639199)], [np.float64(-0.055782), np.float64(0.783919), np.float64(0.642735)], [np.float64(1.172845), np.float64(-0.37193), np.float64(-1.205908)], [np.float64(1.789696), np.float64(-0.86766), np.float64(0.78727)], [np.float64(2.145296), np.float64(3.662286), np.float64(1.536131)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '2003846667223680600001_r13_insertion_RSR_9_1_2_5_IRC_R', 'label': '2003846667223680600001_r13_insertion_RSR_9_1_2_5_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '2003846667223680600001_r13_insertion_RSR_9_1_2_5_IRC_R_prod'
    logfile = '2003846667223680600001_r13_insertion_RSR_9_1_2_5_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '2003846667223680600001_r13_insertion_RSR_9_1_2_5_IRC_R_prod', 'label': '2003846667223680600001_r13_insertion_RSR_9_1_2_5_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
