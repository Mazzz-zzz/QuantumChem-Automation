...
label = '2003846667223680600001_r13_insertion_ROR_3_2_5_8_IRC_F'
logfile = '2003846667223680600001_r13_insertion_ROR_3_2_5_8_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('H')], positions=[[np.float64(1.687048), np.float64(-0.644165), np.float64(-1.261736)], [np.float64(1.966925), np.float64(0.201283), np.float64(0.006615)], [np.float64(-0.565913), np.float64(-0.085409), np.float64(0.287354)], [np.float64(2.021218), np.float64(-0.464583), np.float64(1.061957)], [np.float64(2.198412), np.float64(2.019086), np.float64(0.025708)], [np.float64(2.886638), np.float64(2.286444), np.float64(1.23644)], [np.float64(2.811128), np.float64(2.307703), np.float64(-1.221722)], [np.float64(0.745683), np.float64(2.13782), np.float64(0.065728)], [np.float64(0.944991), np.float64(0.006374), np.float64(-2.117881)], [np.float64(2.900571), np.float64(-0.849328), np.float64(-1.768557)], [np.float64(1.14832), np.float64(-1.802322), np.float64(-0.956405)], [np.float64(-0.54264), np.float64(0.846722), np.float64(0.264593)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '2003846667223680600001_r13_insertion_ROR_3_2_5_8_IRC_F', 'label': '2003846667223680600001_r13_insertion_ROR_3_2_5_8_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '2003846667223680600001_r13_insertion_ROR_3_2_5_8_IRC_F_prod'
    logfile = '2003846667223680600001_r13_insertion_ROR_3_2_5_8_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '2003846667223680600001_r13_insertion_ROR_3_2_5_8_IRC_F_prod', 'label': '2003846667223680600001_r13_insertion_ROR_3_2_5_8_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
