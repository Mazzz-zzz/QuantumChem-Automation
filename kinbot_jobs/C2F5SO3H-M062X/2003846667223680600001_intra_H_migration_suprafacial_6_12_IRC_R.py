...
label = '2003846667223680600001_intra_H_migration_suprafacial_6_12_IRC_R'
logfile = '2003846667223680600001_intra_H_migration_suprafacial_6_12_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('H')], positions=[[np.float64(2.534369), np.float64(-1.771488), np.float64(-1.730048)], [np.float64(1.900943), np.float64(-0.386389), np.float64(-1.993594)], [np.float64(2.562263), np.float64(0.178844), np.float64(-3.013915)], [np.float64(0.633535), np.float64(-0.585668), np.float64(-2.396208)], [np.float64(0.6233), np.float64(0.405645), np.float64(0.646761)], [np.float64(1.954145), np.float64(0.394001), np.float64(-0.899872)], [np.float64(-0.464649), np.float64(-0.421746), np.float64(0.294401)], [np.float64(0.497608), np.float64(1.775895), np.float64(0.957174)], [np.float64(3.83218), np.float64(-1.646593), np.float64(-1.488635)], [np.float64(1.961316), np.float64(-2.30624), np.float64(-0.644125)], [np.float64(2.359638), np.float64(-2.590267), np.float64(-2.749826)], [np.float64(1.955263), np.float64(-0.128285), np.float64(0.450169)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '2003846667223680600001_intra_H_migration_suprafacial_6_12_IRC_R', 'label': '2003846667223680600001_intra_H_migration_suprafacial_6_12_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '2003846667223680600001_intra_H_migration_suprafacial_6_12_IRC_R_prod'
    logfile = '2003846667223680600001_intra_H_migration_suprafacial_6_12_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '2003846667223680600001_intra_H_migration_suprafacial_6_12_IRC_R_prod', 'label': '2003846667223680600001_intra_H_migration_suprafacial_6_12_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
