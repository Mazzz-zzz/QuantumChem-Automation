...
label = '1502984803620600000001_r12_insertion_R_2_1_5_IRC_F'
logfile = '1502984803620600000001_r12_insertion_R_2_1_5_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.115777), np.float64(-0.583311), np.float64(0.321603)], [np.float64(0.044378), np.float64(1.165145), np.float64(-0.193454)], [np.float64(-0.774836), np.float64(-0.507026), np.float64(1.408278)], [np.float64(-0.833314), np.float64(-1.093295), np.float64(-0.599242)], [np.float64(1.633582), np.float64(0.304131), np.float64(0.01998)], [np.float64(2.044408), np.float64(0.153717), np.float64(1.370132)], [np.float64(1.932454), np.float64(-0.491766), np.float64(-1.126045)], [np.float64(2.29656), np.float64(1.708979), np.float64(-0.32556)], [np.float64(2.243059), np.float64(1.856263), np.float64(-1.278804)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_2_1_5_IRC_F', 'label': '1502984803620600000001_r12_insertion_R_2_1_5_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_r12_insertion_R_2_1_5_IRC_F_prod'
    logfile = '1502984803620600000001_r12_insertion_R_2_1_5_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_2_1_5_IRC_F_prod', 'label': '1502984803620600000001_r12_insertion_R_2_1_5_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
