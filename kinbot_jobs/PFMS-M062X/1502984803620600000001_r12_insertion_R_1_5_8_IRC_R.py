...
label = '1502984803620600000001_r12_insertion_R_1_5_8_IRC_R'
logfile = '1502984803620600000001_r12_insertion_R_1_5_8_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.126129), np.float64(-0.105169), np.float64(0.040171)], [np.float64(-0.713935), np.float64(0.375491), np.float64(-1.038174)], [np.float64(-0.592396), np.float64(0.508572), np.float64(1.110393)], [np.float64(-0.362233), np.float64(-1.400945), np.float64(0.133687)], [np.float64(1.698971), np.float64(0.112685), np.float64(-0.076495)], [np.float64(2.269951), np.float64(-0.284765), np.float64(1.158857)], [np.float64(2.131206), np.float64(-0.442653), np.float64(-1.307306)], [np.float64(1.63892), np.float64(1.684647), np.float64(-0.173744)], [np.float64(2.526157), np.float64(2.064963), np.float64(-0.250514)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_1_5_8_IRC_R', 'label': '1502984803620600000001_r12_insertion_R_1_5_8_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_r12_insertion_R_1_5_8_IRC_R_prod'
    logfile = '1502984803620600000001_r12_insertion_R_1_5_8_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_1_5_8_IRC_R_prod', 'label': '1502984803620600000001_r12_insertion_R_1_5_8_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
