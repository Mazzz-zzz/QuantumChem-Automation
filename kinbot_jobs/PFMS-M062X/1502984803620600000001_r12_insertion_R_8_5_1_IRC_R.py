...
label = '1502984803620600000001_r12_insertion_R_8_5_1_IRC_R'
logfile = '1502984803620600000001_r12_insertion_R_8_5_1_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.125577), np.float64(-0.107517), np.float64(0.036481)], [np.float64(-0.70924), np.float64(0.367572), np.float64(-1.046574)], [np.float64(-0.598617), np.float64(0.509137), np.float64(1.102046)], [np.float64(-0.358946), np.float64(-1.403506), np.float64(0.133786)], [np.float64(1.699533), np.float64(0.114464), np.float64(-0.072017)], [np.float64(2.265352), np.float64(-0.27646), np.float64(1.167783)], [np.float64(2.139353), np.float64(-0.4448), np.float64(-1.298358)], [np.float64(1.636011), np.float64(1.685856), np.float64(-0.176033)], [np.float64(2.522642), np.float64(2.068087), np.float64(-0.250238)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_8_5_1_IRC_R', 'label': '1502984803620600000001_r12_insertion_R_8_5_1_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_r12_insertion_R_8_5_1_IRC_R_prod'
    logfile = '1502984803620600000001_r12_insertion_R_8_5_1_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_8_5_1_IRC_R_prod', 'label': '1502984803620600000001_r12_insertion_R_8_5_1_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
