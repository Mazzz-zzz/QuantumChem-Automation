...
kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_R_Addition_MultipleBond_5_1_2_IRC_R', 'label': '1502984803620600000001_R_Addition_MultipleBond_5_1_2_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Read,Mix', 'geom': 'AllCheck,NoKeepConstants', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    ...
    prod_kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_R_Addition_MultipleBond_5_1_2_IRC_R_prod', 'label': '1502984803620600000001_R_Addition_MultipleBond_5_1_2_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Mix,Always', 'freq': 'freq', 'opt': 'CalcFC'}
