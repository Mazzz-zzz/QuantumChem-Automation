...
label = '1502984803620600000001_intra_H_migration_5_9_IRC_F'
logfile = '1502984803620600000001_intra_H_migration_5_9_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.11978), np.float64(-0.035662), np.float64(0.103003)], [np.float64(-0.657594), np.float64(0.694995), np.float64(-0.853409)], [np.float64(-0.633946), np.float64(0.305996), np.float64(1.268083)], [np.float64(-0.348505), np.float64(-1.313234), np.float64(-0.129384)], [np.float64(1.699952), np.float64(0.248951), np.float64(0.145226)], [np.float64(2.221287), np.float64(-0.554239), np.float64(1.18145)], [np.float64(2.17243), np.float64(0.084008), np.float64(-1.266757)], [np.float64(1.880814), np.float64(1.735962), np.float64(0.160027)], [np.float64(2.255856), np.float64(1.346057), np.float64(-1.011364)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_intra_H_migration_5_9_IRC_F', 'label': '1502984803620600000001_intra_H_migration_5_9_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_intra_H_migration_5_9_IRC_F_prod'
    logfile = '1502984803620600000001_intra_H_migration_5_9_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_intra_H_migration_5_9_IRC_F_prod', 'label': '1502984803620600000001_intra_H_migration_5_9_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
