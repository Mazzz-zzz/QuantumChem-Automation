...
label = '1502984803620600000001_r12_insertion_R_5_1_3_IRC_R'
logfile = '1502984803620600000001_r12_insertion_R_5_1_3_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.141362), np.float64(-0.60606), np.float64(-0.244627)], [np.float64(-0.918571), np.float64(-0.403864), np.float64(-1.233517)], [np.float64(0.08318), np.float64(1.068107), np.float64(0.459274)], [np.float64(-0.752433), np.float64(-1.231239), np.float64(0.681001)], [np.float64(1.635578), np.float64(0.24884), np.float64(-0.021295)], [np.float64(2.091922), np.float64(-0.731405), np.float64(0.898034)], [np.float64(1.84995), np.float64(0.360065), np.float64(-1.427688)], [np.float64(2.351781), np.float64(1.54454), np.float64(0.562691)], [np.float64(2.27047), np.float64(2.263854), np.float64(-0.076997)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_5_1_3_IRC_R', 'label': '1502984803620600000001_r12_insertion_R_5_1_3_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_r12_insertion_R_5_1_3_IRC_R_prod'
    logfile = '1502984803620600000001_r12_insertion_R_5_1_3_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_5_1_3_IRC_R_prod', 'label': '1502984803620600000001_r12_insertion_R_5_1_3_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
