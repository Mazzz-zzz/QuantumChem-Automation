...
label = '1502984803620600000001_r12_insertion_R_6_5_1_IRC_F'
logfile = '1502984803620600000001_r12_insertion_R_6_5_1_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.005252), np.float64(0.004012), np.float64(-0.001215)], [np.float64(-0.475551), np.float64(0.574536), np.float64(-1.103075)], [np.float64(-0.41497), np.float64(0.711004), np.float64(1.044356)], [np.float64(-0.452337), np.float64(-1.227405), np.float64(0.089805)], [np.float64(1.838572), np.float64(-0.022869), np.float64(-0.051503)], [np.float64(2.282514), np.float64(-0.492626), np.float64(1.206762)], [np.float64(2.212838), np.float64(-0.643888), np.float64(-1.266118)], [np.float64(2.134164), np.float64(1.52271), np.float64(-0.154267)], [np.float64(1.350537), np.float64(2.087362), np.float64(-0.167865)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_6_5_1_IRC_F', 'label': '1502984803620600000001_r12_insertion_R_6_5_1_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_r12_insertion_R_6_5_1_IRC_F_prod'
    logfile = '1502984803620600000001_r12_insertion_R_6_5_1_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_6_5_1_IRC_F_prod', 'label': '1502984803620600000001_r12_insertion_R_6_5_1_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
