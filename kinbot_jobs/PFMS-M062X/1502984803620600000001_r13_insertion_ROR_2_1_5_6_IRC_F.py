...
label = '1502984803620600000001_r13_insertion_ROR_2_1_5_6_IRC_F'
logfile = '1502984803620600000001_r13_insertion_ROR_2_1_5_6_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(2.037928), np.float64(-0.29215), np.float64(-0.317032)], [np.float64(-0.325071), np.float64(0.995402), np.float64(0.474674)], [np.float64(1.991124), np.float64(-0.999931), np.float64(0.782019)], [np.float64(1.196555), np.float64(-0.750808), np.float64(-1.208678)], [np.float64(2.077477), np.float64(1.444115), np.float64(-0.072302)], [np.float64(0.864861), np.float64(2.188506), np.float64(0.401075)], [np.float64(3.240829), np.float64(1.745229), np.float64(0.677361)], [np.float64(2.162669), np.float64(1.924648), np.float64(-1.55229)], [np.float64(3.036812), np.float64(1.716114), np.float64(-1.915615)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r13_insertion_ROR_2_1_5_6_IRC_F', 'label': '1502984803620600000001_r13_insertion_ROR_2_1_5_6_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_r13_insertion_ROR_2_1_5_6_IRC_F_prod'
    logfile = '1502984803620600000001_r13_insertion_ROR_2_1_5_6_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r13_insertion_ROR_2_1_5_6_IRC_F_prod', 'label': '1502984803620600000001_r13_insertion_ROR_2_1_5_6_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
