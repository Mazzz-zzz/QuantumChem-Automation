...
label = '1502984803620600000001_r12_insertion_R_6_5_8_IRC_R'
logfile = '1502984803620600000001_r12_insertion_R_6_5_8_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.099391), np.float64(-0.016943), np.float64(0.14998)], [np.float64(-0.654653), np.float64(1.148944), np.float64(-0.140499)], [np.float64(-0.478895), np.float64(-0.393385), np.float64(1.352559)], [np.float64(-0.492213), np.float64(-0.911784), np.float64(-0.736128)], [np.float64(1.770405), np.float64(0.114351), np.float64(0.103421)], [np.float64(2.219733), np.float64(0.005467), np.float64(1.437293)], [np.float64(2.213955), np.float64(-0.727164), np.float64(-0.949979)], [np.float64(1.957928), np.float64(1.613897), np.float64(-0.328647)], [np.float64(2.033646), np.float64(1.67945), np.float64(-1.291129)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_6_5_8_IRC_R', 'label': '1502984803620600000001_r12_insertion_R_6_5_8_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_r12_insertion_R_6_5_8_IRC_R_prod'
    logfile = '1502984803620600000001_r12_insertion_R_6_5_8_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_6_5_8_IRC_R_prod', 'label': '1502984803620600000001_r12_insertion_R_6_5_8_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
