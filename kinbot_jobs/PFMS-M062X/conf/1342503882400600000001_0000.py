...
label = 'conf/1342503882400600000001_0000'
logfile = 'conf/1342503882400600000001_0000.log'

mol = Atoms(symbols=['C', 'F', 'F', 'F', 'S', 'O', 'O', 'H'], positions=[[np.float64(0.0), np.float64(0.0), np.float64(0.0)], [np.float64(-0.4552455746714216), np.float64(0.7563399722692932), np.float64(-0.9942944477788116)], [np.float64(-0.4597452891897525), np.float64(0.47798086708842047), np.float64(1.1479517552485525)], [np.float64(-0.4375060005014651), np.float64(-1.236416132808407), np.float64(-0.16311075338038206)], [np.float64(1.8726722241316018), np.float64(0.0), np.float64(0.0)], [np.float64(2.19679620346625), np.float64(-0.5128368029405347), np.float64(-1.3174410938721337)], [np.float64(1.9850584177125938), np.float64(1.6033230786580026), np.float64(0.0)], [np.float64(1.491464041033505), np.float64(1.9755776978502304), np.float64(0.7488831583436972)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'label': 'conf/1342503882400600000001_0000', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
