...
label = '1502984803620600000001_intra_H_migration_suprafacial_6_9_IRC_R'
logfile = '1502984803620600000001_intra_H_migration_suprafacial_6_9_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.838147), np.float64(-0.770661), np.float64(-1.615117)], [np.float64(1.200739), np.float64(0.650551), np.float64(-2.123339)], [np.float64(0.763888), np.float64(-1.512477), np.float64(-1.708839)], [np.float64(2.643362), np.float64(-1.024789), np.float64(-2.602059)], [np.float64(1.374423), np.float64(0.859645), np.float64(0.492279)], [np.float64(2.336431), np.float64(-0.547568), np.float64(-0.484125)], [np.float64(0.374126), np.float64(0.157947), np.float64(1.207663)], [np.float64(2.446566), np.float64(1.515394), np.float64(1.13977)], [np.float64(1.08238), np.float64(1.1365), np.float64(-1.008343)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_intra_H_migration_suprafacial_6_9_IRC_R', 'label': '1502984803620600000001_intra_H_migration_suprafacial_6_9_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_intra_H_migration_suprafacial_6_9_IRC_R_prod'
    logfile = '1502984803620600000001_intra_H_migration_suprafacial_6_9_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_intra_H_migration_suprafacial_6_9_IRC_R_prod', 'label': '1502984803620600000001_intra_H_migration_suprafacial_6_9_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
