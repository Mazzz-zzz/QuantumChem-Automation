...
label = '1502984803620600000001_r12_insertion_R_6_5_7_IRC_F'
logfile = '1502984803620600000001_r12_insertion_R_6_5_7_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.250528), np.float64(-0.062081), np.float64(0.149737)], [np.float64(-1.020149), np.float64(0.555299), np.float64(-0.743615)], [np.float64(-0.442738), np.float64(0.508584), np.float64(1.326486)], [np.float64(-0.619072), np.float64(-1.335209), np.float64(0.205944)], [np.float64(1.605688), np.float64(0.035058), np.float64(-0.603567)], [np.float64(2.03578), np.float64(-0.605392), np.float64(0.705148)], [np.float64(3.164191), np.float64(-0.175105), np.float64(-0.649717)], [np.float64(1.547962), np.float64(1.621666), np.float64(-0.40069)], [np.float64(2.449378), np.float64(1.970016), np.float64(-0.392856)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_6_5_7_IRC_F', 'label': '1502984803620600000001_r12_insertion_R_6_5_7_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_r12_insertion_R_6_5_7_IRC_F_prod'
    logfile = '1502984803620600000001_r12_insertion_R_6_5_7_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_6_5_7_IRC_F_prod', 'label': '1502984803620600000001_r12_insertion_R_6_5_7_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
