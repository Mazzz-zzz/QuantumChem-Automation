...
label = '1502984803620600000001_r12_insertion_R_9_8_5_IRC_F'
logfile = '1502984803620600000001_r12_insertion_R_9_8_5_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.111104), np.float64(-0.064308), np.float64(0.101536)], [np.float64(-0.66805), np.float64(0.655488), np.float64(-0.852162)], [np.float64(-0.634268), np.float64(0.259129), np.float64(1.267818)], [np.float64(-0.305807), np.float64(-1.346579), np.float64(-0.135847)], [np.float64(1.700459), np.float64(0.268343), np.float64(0.145234)], [np.float64(2.242918), np.float64(-0.524636), np.float64(1.178468)], [np.float64(2.177402), np.float64(0.121518), np.float64(-1.267227)], [np.float64(1.841659), np.float64(1.75953), np.float64(0.165901)], [np.float64(2.227307), np.float64(1.384351), np.float64(-1.006843)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_9_8_5_IRC_F', 'label': '1502984803620600000001_r12_insertion_R_9_8_5_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_r12_insertion_R_9_8_5_IRC_F_prod'
    logfile = '1502984803620600000001_r12_insertion_R_9_8_5_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r12_insertion_R_9_8_5_IRC_F_prod', 'label': '1502984803620600000001_r12_insertion_R_9_8_5_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
