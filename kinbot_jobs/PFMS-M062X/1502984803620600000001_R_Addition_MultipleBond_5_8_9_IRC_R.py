...
label = '1502984803620600000001_R_Addition_MultipleBond_5_8_9_IRC_R'
logfile = '1502984803620600000001_R_Addition_MultipleBond_5_8_9_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.257119), np.float64(-0.123432), np.float64(0.118893)], [np.float64(-0.74481), np.float64(0.606769), np.float64(-0.934037)], [np.float64(-0.796682), np.float64(0.294238), np.float64(1.313581)], [np.float64(-0.454628), np.float64(-1.471876), np.float64(-0.069641)], [np.float64(1.705136), np.float64(0.186309), np.float64(0.208666)], [np.float64(2.325754), np.float64(-0.637358), np.float64(1.413245)], [np.float64(2.307287), np.float64(0.062831), np.float64(-1.399616)], [np.float64(1.955248), np.float64(1.879764), np.float64(0.02411)], [np.float64(2.400378), np.float64(1.387158), np.float64(-1.151924)]])

kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_R_Addition_MultipleBond_5_8_9_IRC_R', 'label': '1502984803620600000001_R_Addition_MultipleBond_5_8_9_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Read,Mix', 'geom': 'AllCheck,NoKeepConstants', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_R_Addition_MultipleBond_5_8_9_IRC_R_prod'
    logfile = '1502984803620600000001_R_Addition_MultipleBond_5_8_9_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_R_Addition_MultipleBond_5_8_9_IRC_R_prod', 'label': '1502984803620600000001_R_Addition_MultipleBond_5_8_9_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Mix,Always', 'freq': 'freq', 'opt': 'CalcFC'}
