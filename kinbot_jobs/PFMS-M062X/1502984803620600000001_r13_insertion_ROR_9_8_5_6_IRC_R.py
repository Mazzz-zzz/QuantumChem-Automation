...
label = '1502984803620600000001_r13_insertion_ROR_9_8_5_6_IRC_R'
logfile = '1502984803620600000001_r13_insertion_ROR_9_8_5_6_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(3.365883), np.float64(0.498987), np.float64(1.248385)], [np.float64(3.738736), np.float64(-0.655225), np.float64(0.755074)], [np.float64(3.000454), np.float64(0.379587), np.float64(2.506575)], [np.float64(4.384503), np.float64(1.34313), np.float64(1.16951)], [np.float64(1.883326), np.float64(1.752395), np.float64(0.156871)], [np.float64(-0.023259), np.float64(1.143791), np.float64(-0.344548)], [np.float64(2.464156), np.float64(1.971878), np.float64(-1.121872)], [np.float64(1.435783), np.float64(0.326898), np.float64(0.403706)], [np.float64(-0.5866), np.float64(1.137845), np.float64(0.441354)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r13_insertion_ROR_9_8_5_6_IRC_R', 'label': '1502984803620600000001_r13_insertion_ROR_9_8_5_6_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_r13_insertion_ROR_9_8_5_6_IRC_R_prod'
    logfile = '1502984803620600000001_r13_insertion_ROR_9_8_5_6_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r13_insertion_ROR_9_8_5_6_IRC_R_prod', 'label': '1502984803620600000001_r13_insertion_ROR_9_8_5_6_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
