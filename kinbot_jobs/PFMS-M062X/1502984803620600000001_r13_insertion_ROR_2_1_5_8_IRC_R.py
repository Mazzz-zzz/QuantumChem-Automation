...
label = '1502984803620600000001_r13_insertion_ROR_2_1_5_8_IRC_R'
logfile = '1502984803620600000001_r13_insertion_ROR_2_1_5_8_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.589658), np.float64(0.083565), np.float64(-0.081593)], [np.float64(-0.475985), np.float64(0.560446), np.float64(0.086774)], [np.float64(1.618328), np.float64(-0.674739), np.float64(0.921)], [np.float64(1.519704), np.float64(-0.551001), np.float64(-1.161536)], [np.float64(2.08696), np.float64(1.962006), np.float64(0.025258)], [np.float64(3.315424), np.float64(1.796993), np.float64(0.722097)], [np.float64(2.09781), np.float64(2.290736), np.float64(-1.354794)], [np.float64(0.959781), np.float64(2.429146), np.float64(0.801738)], [np.float64(-0.231334), np.float64(1.430541), np.float64(0.418634)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r13_insertion_ROR_2_1_5_8_IRC_R', 'label': '1502984803620600000001_r13_insertion_ROR_2_1_5_8_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_r13_insertion_ROR_2_1_5_8_IRC_R_prod'
    logfile = '1502984803620600000001_r13_insertion_ROR_2_1_5_8_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1502984803620600000001_r13_insertion_ROR_2_1_5_8_IRC_R_prod', 'label': '1502984803620600000001_r13_insertion_ROR_2_1_5_8_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
