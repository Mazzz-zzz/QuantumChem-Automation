...
label = '1141903082400600000001_r13_insertion_CO2_3_8_IRC_R'
logfile = '1141903082400600000001_r13_insertion_CO2_3_8_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(2.012622), np.float64(0.2226), np.float64(-0.307404)], [np.float64(2.170077), np.float64(-0.29444), np.float64(-1.315454)], [np.float64(-0.075835), np.float64(0.216016), np.float64(0.142907)], [np.float64(-0.806799), np.float64(0.68786), np.float64(1.183116)], [np.float64(-0.564911), np.float64(0.797508), np.float64(-0.959484)], [np.float64(-0.341595), np.float64(-1.093383), np.float64(0.054966)], [np.float64(2.382291), np.float64(0.813018), np.float64(0.722423)], [np.float64(1.21944), np.float64(0.7437), np.float64(0.848528)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r13_insertion_CO2_3_8_IRC_R', 'label': '1141903082400600000001_r13_insertion_CO2_3_8_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_r13_insertion_CO2_3_8_IRC_R_prod'
    logfile = '1141903082400600000001_r13_insertion_CO2_3_8_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r13_insertion_CO2_3_8_IRC_R_prod', 'label': '1141903082400600000001_r13_insertion_CO2_3_8_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
