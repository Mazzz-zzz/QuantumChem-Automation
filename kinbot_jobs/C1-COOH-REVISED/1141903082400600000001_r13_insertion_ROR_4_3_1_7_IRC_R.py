...
label = '1141903082400600000001_r13_insertion_ROR_4_3_1_7_IRC_R'
logfile = '1141903082400600000001_r13_insertion_ROR_4_3_1_7_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(3.978183), np.float64(1.250886), np.float64(-0.386989)], [np.float64(4.900732), np.float64(1.864133), np.float64(-0.546429)], [np.float64(0.970456), np.float64(0.550953), np.float64(0.177866)], [np.float64(-0.730896), np.float64(0.445622), np.float64(0.508433)], [np.float64(1.079626), np.float64(-0.08628), np.float64(-0.942325)], [np.float64(1.487543), np.float64(-0.144884), np.float64(1.137711)], [np.float64(0.901718), np.float64(1.8011), np.float64(0.226529)], [np.float64(-0.265853), np.float64(1.545029), np.float64(0.448008)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r13_insertion_ROR_4_3_1_7_IRC_R', 'label': '1141903082400600000001_r13_insertion_ROR_4_3_1_7_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_r13_insertion_ROR_4_3_1_7_IRC_R_prod'
    logfile = '1141903082400600000001_r13_insertion_ROR_4_3_1_7_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r13_insertion_ROR_4_3_1_7_IRC_R_prod', 'label': '1141903082400600000001_r13_insertion_ROR_4_3_1_7_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
