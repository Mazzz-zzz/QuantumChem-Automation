...
label = '1141903082400600000001_r12_insertion_R_7_1_2_IRC_F'
logfile = '1141903082400600000001_r12_insertion_R_7_1_2_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.475206), np.float64(-0.071342), np.float64(0.434299)], [np.float64(2.295073), np.float64(-0.454298), np.float64(-0.706917)], [np.float64(-0.005273), np.float64(-0.055893), np.float64(0.089361)], [np.float64(-0.634086), np.float64(0.773207), np.float64(0.921311)], [np.float64(-0.272751), np.float64(0.352473), np.float64(-1.156034)], [np.float64(-0.506935), np.float64(-1.277018), np.float64(0.232289)], [np.float64(2.032784), np.float64(1.0927), np.float64(-0.081604)], [np.float64(2.935603), np.float64(1.144449), np.float64(0.266207)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_7_1_2_IRC_F', 'label': '1141903082400600000001_r12_insertion_R_7_1_2_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_r12_insertion_R_7_1_2_IRC_F_prod'
    logfile = '1141903082400600000001_r12_insertion_R_7_1_2_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_7_1_2_IRC_F_prod', 'label': '1141903082400600000001_r12_insertion_R_7_1_2_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
