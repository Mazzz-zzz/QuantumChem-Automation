...
label = '1141903082400600000001_r12_insertion_R_2_1_3_IRC_F'
logfile = '1141903082400600000001_r12_insertion_R_2_1_3_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.563338), np.float64(0.420167), np.float64(0.426505)], [np.float64(1.539918), np.float64(-0.202638), np.float64(-0.680804)], [np.float64(-0.07177), np.float64(-0.124768), np.float64(-0.105978)], [np.float64(-0.807619), np.float64(0.862087), np.float64(0.414328)], [np.float64(-0.59637), np.float64(-0.269774), np.float64(-1.326063)], [np.float64(-0.241172), np.float64(-1.236325), np.float64(0.559209)], [np.float64(2.643676), np.float64(1.080993), np.float64(0.720237)], [np.float64(3.289623), np.float64(0.97453), np.float64(-0.008517)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_2_1_3_IRC_F', 'label': '1141903082400600000001_r12_insertion_R_2_1_3_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_r12_insertion_R_2_1_3_IRC_F_prod'
    logfile = '1141903082400600000001_r12_insertion_R_2_1_3_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_2_1_3_IRC_F_prod', 'label': '1141903082400600000001_r12_insertion_R_2_1_3_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
