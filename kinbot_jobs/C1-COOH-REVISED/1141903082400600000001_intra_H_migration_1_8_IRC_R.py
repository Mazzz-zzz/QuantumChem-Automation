...
label = '1141903082400600000001_intra_H_migration_1_8_IRC_R'
logfile = '1141903082400600000001_intra_H_migration_1_8_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.483313), np.float64(0.28646), np.float64(0.015261)], [np.float64(2.338393), np.float64(-0.541775), np.float64(-0.3785)], [np.float64(-0.021832), np.float64(0.012297), np.float64(0.013122)], [np.float64(-0.626622), np.float64(0.722016), np.float64(0.950101)], [np.float64(-0.513728), np.float64(0.355899), np.float64(-1.172445)], [np.float64(-0.261219), np.float64(-1.271336), np.float64(0.220818)], [np.float64(1.989899), np.float64(1.375761), np.float64(0.374185)], [np.float64(2.931419), np.float64(0.564952), np.float64(-0.023629)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_intra_H_migration_1_8_IRC_R', 'label': '1141903082400600000001_intra_H_migration_1_8_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_intra_H_migration_1_8_IRC_R_prod'
    logfile = '1141903082400600000001_intra_H_migration_1_8_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_intra_H_migration_1_8_IRC_R_prod', 'label': '1141903082400600000001_intra_H_migration_1_8_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
