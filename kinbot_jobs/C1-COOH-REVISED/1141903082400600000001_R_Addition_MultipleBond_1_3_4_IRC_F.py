...
label = '1141903082400600000001_R_Addition_MultipleBond_1_3_4_IRC_F'
logfile = '1141903082400600000001_R_Addition_MultipleBond_1_3_4_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.587781), np.float64(0.065588), np.float64(0.138996)], [np.float64(2.240757), np.float64(-0.788033), np.float64(0.766181)], [np.float64(0.057254), np.float64(0.02485), np.float64(0.058917)], [np.float64(-0.477416), np.float64(0.086705), np.float64(1.351259)], [np.float64(-0.487615), np.float64(1.06324), np.float64(-0.686471)], [np.float64(-0.345779), np.float64(-1.185621), np.float64(-0.517425)], [np.float64(2.108561), np.float64(1.134757), np.float64(-0.552258)], [np.float64(3.09218), np.float64(1.144318), np.float64(-0.489475)]])

kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_R_Addition_MultipleBond_1_3_4_IRC_F', 'label': '1141903082400600000001_R_Addition_MultipleBond_1_3_4_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Read,Mix', 'geom': 'AllCheck,NoKeepConstants', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_R_Addition_MultipleBond_1_3_4_IRC_F_prod'
    logfile = '1141903082400600000001_R_Addition_MultipleBond_1_3_4_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_R_Addition_MultipleBond_1_3_4_IRC_F_prod', 'label': '1141903082400600000001_R_Addition_MultipleBond_1_3_4_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Mix,Always', 'freq': 'freq', 'opt': 'CalcFC'}
