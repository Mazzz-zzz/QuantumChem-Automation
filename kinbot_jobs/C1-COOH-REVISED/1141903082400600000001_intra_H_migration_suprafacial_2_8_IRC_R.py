...
label = '1141903082400600000001_intra_H_migration_suprafacial_2_8_IRC_R'
logfile = '1141903082400600000001_intra_H_migration_suprafacial_2_8_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.366709), np.float64(-0.128847), np.float64(-0.503434)], [np.float64(0.715921), np.float64(-0.582317), np.float64(-1.474465)], [np.float64(1.609541), np.float64(-0.908074), np.float64(0.79062)], [np.float64(2.730695), np.float64(-1.609086), np.float64(0.659152)], [np.float64(1.738226), np.float64(-0.081781), np.float64(1.814582)], [np.float64(0.609702), np.float64(-1.739398), np.float64(1.028933)], [np.float64(1.830431), np.float64(1.015759), np.float64(-0.720189)], [np.float64(1.169425), np.float64(0.605371), np.float64(-1.767593)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_intra_H_migration_suprafacial_2_8_IRC_R', 'label': '1141903082400600000001_intra_H_migration_suprafacial_2_8_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_intra_H_migration_suprafacial_2_8_IRC_R_prod'
    logfile = '1141903082400600000001_intra_H_migration_suprafacial_2_8_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_intra_H_migration_suprafacial_2_8_IRC_R_prod', 'label': '1141903082400600000001_intra_H_migration_suprafacial_2_8_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
