...
label = '1141903082400600000001_r12_insertion_R_8_7_1_IRC_R'
logfile = '1141903082400600000001_r12_insertion_R_8_7_1_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.478881), np.float64(0.309294), np.float64(-0.014999)], [np.float64(2.240565), np.float64(-0.00537), np.float64(-0.9598)], [np.float64(-0.023091), np.float64(0.018426), np.float64(0.001325)], [np.float64(-0.676085), np.float64(0.995429), np.float64(0.608658)], [np.float64(-0.488395), np.float64(-0.113132), np.float64(-1.228454)], [np.float64(-0.229667), np.float64(-1.114534), np.float64(0.663863)], [np.float64(2.084218), np.float64(0.857942), np.float64(0.936289)], [np.float64(2.9332), np.float64(0.556217), np.float64(-0.007967)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_8_7_1_IRC_R', 'label': '1141903082400600000001_r12_insertion_R_8_7_1_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_r12_insertion_R_8_7_1_IRC_R_prod'
    logfile = '1141903082400600000001_r12_insertion_R_8_7_1_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_8_7_1_IRC_R_prod', 'label': '1141903082400600000001_r12_insertion_R_8_7_1_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
