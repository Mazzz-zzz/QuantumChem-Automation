...
label = '1141903082400600000001_r12_insertion_R_1_3_4_IRC_R'
logfile = '1141903082400600000001_r12_insertion_R_1_3_4_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.638473), np.float64(-0.127026), np.float64(0.238919)], [np.float64(2.067874), np.float64(-1.202448), np.float64(0.46889)], [np.float64(0.042681), np.float64(-0.133909), np.float64(-0.520141)], [np.float64(0.678628), np.float64(0.511095), np.float64(1.286409)], [np.float64(-0.589994), np.float64(0.877415), np.float64(-0.966991)], [np.float64(-0.760569), np.float64(-1.079024), np.float64(-0.282026)], [np.float64(2.322016), np.float64(0.916978), np.float64(-0.260309)], [np.float64(1.920518), np.float64(1.741194), np.float64(0.034162)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_1_3_4_IRC_R', 'label': '1141903082400600000001_r12_insertion_R_1_3_4_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_r12_insertion_R_1_3_4_IRC_R_prod'
    logfile = '1141903082400600000001_r12_insertion_R_1_3_4_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_1_3_4_IRC_R_prod', 'label': '1141903082400600000001_r12_insertion_R_1_3_4_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
