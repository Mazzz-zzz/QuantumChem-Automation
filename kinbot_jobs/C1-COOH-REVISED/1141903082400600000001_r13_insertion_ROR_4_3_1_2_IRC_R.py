...
label = '1141903082400600000001_r13_insertion_ROR_4_3_1_2_IRC_R'
logfile = '1141903082400600000001_r13_insertion_ROR_4_3_1_2_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(2.01016), np.float64(1.167963), np.float64(0.481217)], [np.float64(1.043021), np.float64(0.590741), np.float64(-1.633324)], [np.float64(1.304451), np.float64(-0.126562), np.float64(-0.710233)], [np.float64(1.179669), np.float64(2.048012), np.float64(0.958845)], [np.float64(0.357739), np.float64(-0.674985), np.float64(0.063045)], [np.float64(2.325619), np.float64(-0.994316), np.float64(-0.740159)], [np.float64(3.184058), np.float64(1.645312), np.float64(0.357716)], [np.float64(3.242764), np.float64(2.588312), np.float64(0.602901)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r13_insertion_ROR_4_3_1_2_IRC_R', 'label': '1141903082400600000001_r13_insertion_ROR_4_3_1_2_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_r13_insertion_ROR_4_3_1_2_IRC_R_prod'
    logfile = '1141903082400600000001_r13_insertion_ROR_4_3_1_2_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r13_insertion_ROR_4_3_1_2_IRC_R_prod', 'label': '1141903082400600000001_r13_insertion_ROR_4_3_1_2_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
