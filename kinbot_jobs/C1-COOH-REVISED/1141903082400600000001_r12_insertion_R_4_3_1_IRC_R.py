...
label = '1141903082400600000001_r12_insertion_R_4_3_1_IRC_R'
logfile = '1141903082400600000001_r12_insertion_R_4_3_1_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.645357), np.float64(-0.134183), np.float64(0.20623)], [np.float64(2.070948), np.float64(-1.212465), np.float64(0.429702)], [np.float64(0.012881), np.float64(-0.128301), np.float64(-0.470577)], [np.float64(0.748671), np.float64(0.532136), np.float64(1.291532)], [np.float64(-0.627999), np.float64(0.885806), np.float64(-0.899111)], [np.float64(-0.790016), np.float64(-1.058292), np.float64(-0.177961)], [np.float64(2.316968), np.float64(0.89283), np.float64(-0.341972)], [np.float64(1.942811), np.float64(1.726748), np.float64(-0.038928)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_4_3_1_IRC_R', 'label': '1141903082400600000001_r12_insertion_R_4_3_1_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_r12_insertion_R_4_3_1_IRC_R_prod'
    logfile = '1141903082400600000001_r12_insertion_R_4_3_1_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_4_3_1_IRC_R_prod', 'label': '1141903082400600000001_r12_insertion_R_4_3_1_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
