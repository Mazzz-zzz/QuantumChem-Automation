...
label = '1141903082400600000001_r13_insertion_ROR_8_7_1_2_IRC_R'
logfile = '1141903082400600000001_r13_insertion_ROR_8_7_1_2_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.928729), np.float64(1.0591), np.float64(-0.164815)], [np.float64(-0.224709), np.float64(1.055159), np.float64(0.814015)], [np.float64(3.389827), np.float64(1.155015), np.float64(-0.623913)], [np.float64(4.20028), np.float64(0.937641), np.float64(0.387532)], [np.float64(3.644479), np.float64(0.27088), np.float64(-1.57378)], [np.float64(3.570657), np.float64(2.375173), np.float64(-1.092887)], [np.float64(0.980515), np.float64(0.744399), np.float64(-0.710729)], [np.float64(-1.182619), np.float64(0.930226), np.float64(0.873235)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r13_insertion_ROR_8_7_1_2_IRC_R', 'label': '1141903082400600000001_r13_insertion_ROR_8_7_1_2_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_r13_insertion_ROR_8_7_1_2_IRC_R_prod'
    logfile = '1141903082400600000001_r13_insertion_ROR_8_7_1_2_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r13_insertion_ROR_8_7_1_2_IRC_R_prod', 'label': '1141903082400600000001_r13_insertion_ROR_8_7_1_2_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
