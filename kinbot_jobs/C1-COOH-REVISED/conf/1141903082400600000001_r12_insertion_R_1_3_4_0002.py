...
label = 'conf/1141903082400600000001_r12_insertion_R_1_3_4_0002'
logfile = 'conf/1141903082400600000001_r12_insertion_R_1_3_4_0002.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.7671365443997247), np.float64(0.0), np.float64(0.0)], [np.float64(2.2494956133281234), np.float64(-0.8902015097677991), np.float64(-0.6071864280068012)], [np.float64(0.0), np.float64(0.0), np.float64(0.0)], [np.float64(1.352786545064656), np.float64(-0.2687333099091803), np.float64(1.477102779417291)], [np.float64(-0.7593316576245713), np.float64(0.9019935090742627), np.float64(0.48223640926211564)], [np.float64(-0.6267662689422977), np.float64(-1.0926288290825326), np.float64(-0.09207586504554434)], [np.float64(2.174028885111431), np.float64(1.2809537868007372), np.float64(0.0)], [np.float64(1.9411589002015859), np.float64(1.6976655400300533), np.float64(0.8362826755049025)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'label': 'conf/1141903082400600000001_r12_insertion_R_1_3_4_0002', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'opt': 'NoFreeze,TS,CalcAll,NoEigentest,MaxCycle=999'}
