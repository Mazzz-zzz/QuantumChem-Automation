...
label = 'conf/1141903082400600000001_r12_insertion_R_4_3_1_0000'
logfile = 'conf/1141903082400600000001_r12_insertion_R_4_3_1_0000.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.7672238691657036), np.float64(0.0), np.float64(0.0)], [np.float64(2.2495379533153206), np.float64(-0.890325527295135), np.float64(-0.6070033651196309)], [np.float64(0.0), np.float64(0.0), np.float64(0.0)], [np.float64(1.3523371731603253), np.float64(-0.26856240398072434), np.float64(1.4770411261054428)], [np.float64(-0.7595081928276891), np.float64(0.9018362677702859), np.float64(0.482307186517866)], [np.float64(-0.6265167294965863), np.float64(-1.0927963835063759), np.float64(-0.09178141425303125)], [np.float64(2.174258320152147), np.float64(1.2808846263439047), np.float64(0.0)], [np.float64(3.12922681989845), np.float64(1.3201717432945181), np.float64(-0.11721793481802893)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'label': 'conf/1141903082400600000001_r12_insertion_R_4_3_1_0000', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'opt': 'NoFreeze,TS,CalcAll,NoEigentest,MaxCycle=999'}
