...
label = 'conf/951592011700400000002_0000'
logfile = 'conf/951592011700400000002_0000.log'

mol = Atoms(symbols=['C', 'O', 'C', 'F', 'F', 'O', 'H'], positions=[[np.float64(1.4345951274038957), np.float64(0.0), np.float64(0.0)], [np.float64(2.094418773809255), np.float64(-1.0095233070328058), np.float64(0.0002264793202119142)], [np.float64(0.0), np.float64(0.0), np.float64(0.0)], [np.float64(-0.7321821366588784), np.float64(1.074294985589511), np.float64(-0.0014647729761212583)], [np.float64(-0.682290079111935), np.float64(-1.102238555792648), np.float64(-0.0017629292575886226)], [np.float64(1.9310213441363993), np.float64(1.251135141018209), np.float64(0.0)], [np.float64(1.6052641950718798), np.float64(1.6809515237240955), np.float64(-0.800810630087403)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'label': 'conf/951592011700400000002_0000', 'Symm': 'None', 'mult': 2, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
