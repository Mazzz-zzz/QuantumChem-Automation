...
label = '1141903082400600000001_r12_insertion_R_3_1_7_IRC_F'
logfile = '1141903082400600000001_r12_insertion_R_3_1_7_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.551193), np.float64(-0.46385), np.float64(0.048473)], [np.float64(2.673871), np.float64(-0.852047), np.float64(0.099367)], [np.float64(-0.024153), np.float64(0.080878), np.float64(-0.022717)], [np.float64(-0.285631), np.float64(0.812491), np.float64(1.02397)], [np.float64(-0.223099), np.float64(0.711822), np.float64(-1.145771)], [np.float64(-0.874789), np.float64(-0.955533), np.float64(0.000846)], [np.float64(1.772911), np.float64(1.031871), np.float64(-0.017299)], [np.float64(2.729317), np.float64(1.138644), np.float64(0.012043)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_3_1_7_IRC_F', 'label': '1141903082400600000001_r12_insertion_R_3_1_7_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_r12_insertion_R_3_1_7_IRC_F_prod'
    logfile = '1141903082400600000001_r12_insertion_R_3_1_7_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_3_1_7_IRC_F_prod', 'label': '1141903082400600000001_r12_insertion_R_3_1_7_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
