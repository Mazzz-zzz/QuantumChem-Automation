...
if success:
    label = '1141903082400600000001_R_Addition_MultipleBond_1_7_8_IRC_F_prod'
    logfile = '1141903082400600000001_R_Addition_MultipleBond_1_7_8_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_R_Addition_MultipleBond_1_7_8_IRC_F_prod', 'label': '1141903082400600000001_R_Addition_MultipleBond_1_7_8_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Mix,Always', 'freq': 'freq', 'opt': 'CalcFC'}
