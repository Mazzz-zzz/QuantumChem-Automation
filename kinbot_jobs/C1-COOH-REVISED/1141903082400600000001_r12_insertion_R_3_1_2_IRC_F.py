...
label = '1141903082400600000001_r12_insertion_R_3_1_2_IRC_F'
logfile = '1141903082400600000001_r12_insertion_R_3_1_2_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.548342), np.float64(0.451274), np.float64(0.431217)], [np.float64(1.563912), np.float64(-0.193413), np.float64(-0.663677)], [np.float64(-0.057768), np.float64(-0.163061), np.float64(-0.113248)], [np.float64(-0.836077), np.float64(0.806859), np.float64(0.376198)], [np.float64(-0.558851), np.float64(-0.351385), np.float64(-1.3374)], [np.float64(-0.197129), np.float64(-1.266573), np.float64(0.571997)], [np.float64(2.598782), np.float64(1.158269), np.float64(0.725848)], [np.float64(3.258416), np.float64(1.062304), np.float64(0.007981)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_3_1_2_IRC_F', 'label': '1141903082400600000001_r12_insertion_R_3_1_2_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_r12_insertion_R_3_1_2_IRC_F_prod'
    logfile = '1141903082400600000001_r12_insertion_R_3_1_2_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_3_1_2_IRC_F_prod', 'label': '1141903082400600000001_r12_insertion_R_3_1_2_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
