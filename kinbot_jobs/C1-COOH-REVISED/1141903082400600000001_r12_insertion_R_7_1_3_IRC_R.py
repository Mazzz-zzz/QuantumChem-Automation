...
label = '1141903082400600000001_r12_insertion_R_7_1_3_IRC_R'
logfile = '1141903082400600000001_r12_insertion_R_7_1_3_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('O'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.721969), np.float64(-0.715689), np.float64(-0.319469)], [np.float64(2.69633), np.float64(-1.287457), np.float64(-0.162482)], [np.float64(0.147272), np.float64(0.237876), np.float64(-0.03704)], [np.float64(-0.271921), np.float64(1.147529), np.float64(0.856933)], [np.float64(-0.284071), np.float64(0.532716), np.float64(-1.230461)], [np.float64(-0.507357), np.float64(-0.86242), np.float64(0.405788)], [np.float64(1.732008), np.float64(1.015488), np.float64(-0.15699)], [np.float64(2.085401), np.float64(1.436233), np.float64(0.642632)]])

kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_7_1_3_IRC_R', 'label': '1141903082400600000001_r12_insertion_R_7_1_3_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1141903082400600000001_r12_insertion_R_7_1_3_IRC_R_prod'
    logfile = '1141903082400600000001_r12_insertion_R_7_1_3_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1141903082400600000001_r12_insertion_R_7_1_3_IRC_R_prod', 'label': '1141903082400600000001_r12_insertion_R_7_1_3_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
