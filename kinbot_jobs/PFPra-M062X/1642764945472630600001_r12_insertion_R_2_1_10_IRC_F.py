...
label = '1642764945472630600001_r12_insertion_R_2_1_10_IRC_F'
logfile = '1642764945472630600001_r12_insertion_R_2_1_10_IRC_F.log'
...
kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1642764945472630600001_r12_insertion_R_2_1_10_IRC_F', 'label': '1642764945472630600001_r12_insertion_R_2_1_10_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1642764945472630600001_r12_insertion_R_2_1_10_IRC_F_prod'
    logfile = '1642764945472630600001_r12_insertion_R_2_1_10_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'M062X', 'basis': 'Def2TZVPP', 'nprocshared': 8, 'mem': '28GB', 'chk': '1642764945472630600001_r12_insertion_R_2_1_10_IRC_F_prod', 'label': '1642764945472630600001_r12_insertion_R_2_1_10_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
