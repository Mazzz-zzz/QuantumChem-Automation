...
label = '1642764945472630600001_R_Addition_MultipleBond_1_3_8_IRC_F'
logfile = '1642764945472630600001_R_Addition_MultipleBond_1_3_8_IRC_F.log'
...
if success:
    label = '1642764945472630600001_R_Addition_MultipleBond_1_3_8_IRC_F_prod'
    logfile = '1642764945472630600001_R_Addition_MultipleBond_1_3_8_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '28GB', 'chk': '1642764945472630600001_R_Addition_MultipleBond_1_3_8_IRC_F_prod', 'label': '1642764945472630600001_R_Addition_MultipleBond_1_3_8_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Mix,Always', 'freq': 'freq', 'opt': 'CalcFC'}
