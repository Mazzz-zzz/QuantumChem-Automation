...
label = '2003846667223680600001_r13_insertion_ROR_12_8_5_6_IRC_R'
logfile = '2003846667223680600001_r13_insertion_ROR_12_8_5_6_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('H')], positions=[[np.float64(4.128664), np.float64(2.130441), np.float64(1.813476)], [np.float64(3.35135), np.float64(0.882155), np.float64(1.301936)], [np.float64(4.157781), np.float64(0.10703), np.float64(0.594528)], [np.float64(2.847413), np.float64(0.216301), np.float64(2.32457)], [np.float64(1.852568), np.float64(1.430679), np.float64(0.211838)], [np.float64(-0.425554), np.float64(1.109874), np.float64(0.419811)], [np.float64(2.350017), np.float64(2.18144), np.float64(-0.930664)], [np.float64(1.265975), np.float64(0.070388), np.float64(0.029171)], [np.float64(4.769281), np.float64(2.723454), np.float64(0.822111)], [np.float64(3.275882), np.float64(2.987759), np.float64(2.366236)], [np.float64(5.007196), np.float64(1.740866), np.float64(2.729864)], [np.float64(-1.333675), np.float64(1.020375), np.float64(0.08568)]])

kwargs = {'method': 'wb97xd', 'basis': '6-311++G(d,p)', 'nprocshared': 8, 'mem': '28GB', 'chk': '2003846667223680600001_r13_insertion_ROR_12_8_5_6_IRC_R', 'label': '2003846667223680600001_r13_insertion_ROR_12_8_5_6_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '2003846667223680600001_r13_insertion_ROR_12_8_5_6_IRC_R_prod'
    logfile = '2003846667223680600001_r13_insertion_ROR_12_8_5_6_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'wb97xd', 'basis': '6-311++G(d,p)', 'nprocshared': 8, 'mem': '28GB', 'chk': '2003846667223680600001_r13_insertion_ROR_12_8_5_6_IRC_R_prod', 'label': '2003846667223680600001_r13_insertion_ROR_12_8_5_6_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
