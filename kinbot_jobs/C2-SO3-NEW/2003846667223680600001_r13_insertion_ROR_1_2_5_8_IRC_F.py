...
label = '2003846667223680600001_r13_insertion_ROR_1_2_5_8_IRC_F'
logfile = '2003846667223680600001_r13_insertion_ROR_1_2_5_8_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('C'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('H')], positions=[[np.float64(0.279918), np.float64(-0.19278), np.float64(0.451603)], [np.float64(1.641915), np.float64(-0.034227), np.float64(-0.067161)], [np.float64(2.497455), np.float64(-0.687631), np.float64(0.730404)], [np.float64(1.706798), np.float64(-0.492232), np.float64(-1.31589)], [np.float64(2.32561), np.float64(1.890367), np.float64(-0.039031)], [np.float64(2.258516), np.float64(2.148325), np.float64(1.380237)], [np.float64(3.594044), np.float64(1.641938), np.float64(-0.669818)], [np.float64(1.325865), np.float64(2.585666), np.float64(-0.866835)], [np.float64(0.043194), np.float64(-0.127333), np.float64(1.678113)], [np.float64(-0.744343), np.float64(1.900252), np.float64(0.231236)], [np.float64(-0.678878), np.float64(-0.527306), np.float64(-0.284349)], [np.float64(-0.0581), np.float64(2.39913), np.float64(-0.232682)]])

kwargs = {'method': 'wb97xd', 'basis': '6-311++G(d,p)', 'nprocshared': 8, 'mem': '28GB', 'chk': '2003846667223680600001_r13_insertion_ROR_1_2_5_8_IRC_F', 'label': '2003846667223680600001_r13_insertion_ROR_1_2_5_8_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '2003846667223680600001_r13_insertion_ROR_1_2_5_8_IRC_F_prod'
    logfile = '2003846667223680600001_r13_insertion_ROR_1_2_5_8_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'wb97xd', 'basis': '6-311++G(d,p)', 'nprocshared': 8, 'mem': '28GB', 'chk': '2003846667223680600001_r13_insertion_ROR_1_2_5_8_IRC_F_prod', 'label': '2003846667223680600001_r13_insertion_ROR_1_2_5_8_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
