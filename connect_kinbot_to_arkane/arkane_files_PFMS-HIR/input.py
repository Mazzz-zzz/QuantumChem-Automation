...
species('1001961801040200000001', '1001961801040200000001.py', structure=SMILES('[H][O][S](=[O])[O][F]'))
...
species('1502824203031350600001', '1502824203031350600001.py', structure=SMILES('[H][O][O][S](=[O])[C]([F])([F])[F]'))
...
transitionState('1502984803620600000001_r13_insertion_ROR_2_1_5_6', '1502984803620600000001_r13_insertion_ROR_2_1_5_6.py')
transitionState('1502984803620600000001_r13_insertion_ROR_9_8_5_6', '1502984803620600000001_r13_insertion_ROR_9_8_5_6.py')
...
reaction(
    ...
    reactants      = ['1502984803620600000001'],
    products       = ['1001961801040200000001', '500620380000000000001'],
    transitionState= '1502984803620600000001_r13_insertion_ROR_2_1_5_6',
)

reaction(
    label          = '1502984803620600000001 <=> 1502824203031350600001',
    reactants      = ['1502984803620600000001'],
    products       = ['1502824203031350600001'],
    transitionState= '1502984803620600000001_r13_insertion_ROR_9_8_5_6',
)
...
statmech('1001961801040200000001')
thermo('1001961801040200000001', 'NASA')
...
statmech('1502824203031350600001')
thermo('1502824203031350600001', 'NASA')
...
statmech('1502984803620600000001_r13_insertion_ROR_2_1_5_6')
statmech('1502984803620600000001_r13_insertion_ROR_9_8_5_6')
