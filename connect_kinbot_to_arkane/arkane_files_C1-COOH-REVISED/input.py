...
species('1141942881381180600001', '1141942881381180600001.py', structure=SMILES('[H][O][C][O][C]([F])([F])[F]'))
species('1142223813092830600001', '1142223813092830600001.py', structure=SMILES('[C](OO)C(F)(F)F'))
...
reaction(
    label          = '1141903082400600000001 <=> 1142223813092830600001',
    reactants      = ['1141903082400600000001'],
    products       = ['1142223813092830600001'],
    transitionState= '1141903082400600000001_r12_insertion_R_7_1_2',
)
...
statmech('1141942881381180600001')
thermo('1141942881381180600001', 'NASA')

statmech('1142223813092830600001')
thermo('1142223813092830600001', 'NASA')
