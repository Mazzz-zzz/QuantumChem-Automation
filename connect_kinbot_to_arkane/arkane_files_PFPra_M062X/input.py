...
species('1643085676164723230601', '1643085676164723230601.py', structure=SMILES('[C](OO)C(C(F)(F)F)(F)F'))
...
reaction(
    label          = '1642764945472630600001 <=> 1643085676164723230601',
    reactants      = ['1642764945472630600001'],
    products       = ['1643085676164723230601'],
    transitionState= '1642764945472630600001_r12_insertion_R_10_1_2',
)
...
statmech('1643085676164723230601')
thermo('1643085676164723230601', 'NASA')
