...
# ------------------------ species (external *.py) ----------------------------
species('C3-SO3-HIR', 'my_C3-SO3-HIR.py', structure=SMILES('C(C(F)(F)F)(C(F)(F)S(=O)(=O)O)(F)F'))
...
# reaction(
#     label          = 'C3-SO3-HIR <=> Product1 + Product2',
#     reactants      = ['C3-SO3-HIR'],
